...
monocyte_proyect <- split(monocyte,monocyte$harmonized_donor_sex)
...
pca_df$color <- ifelse(pca_df$sample %in% monocyte_proyect$male$EpiRR, "blue",
                       ifelse(pca_df$sample %in% monocyte_proyect$female$EpiRR, "red", "grey"))
# Plot
